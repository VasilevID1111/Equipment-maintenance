...
{
    public partial class Form5 : Form //служебная записка
    {
        ...
        private void insertBD(List<string> act)
        {
            ...
            try
            {
                NpgsqlCommand com = new NpgsqlCommand($"insert into service_memos values ('{act[1]}', '{act[2]}', '{act[3]}', '{act[4]}', '{act[0]}', '{DateTime.Now.ToString()}')", conn); //insert-им акт передачи
